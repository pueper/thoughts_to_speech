...
enum SubjectTypes {
  ...
  setupWrite() async {
    ...
    Subject subject3 = Subject("pineapple", "assets/images/food/ananas.jpg", "assets/audio/pineapple.mp3", "food", true, false, false, false);
    Subject subject10 = Subject("apple", "assets/images/food/appel.jpg", "assets/audio/apple.mp3", "food", true, false, false, false);
    Subject subject11 = Subject("banana", "assets/images/food/banana.jpg", "assets/audio/banana.mp3", "food", true, false, false, false);
    Subject subject12 = Subject("cocktail", "assets/images/food/cocktailglass.jpg", "assets/audio/cocktailglass.mp3", "food", true, false, false, false);
    Subject subject13 = Subject("coffee", "assets/images/food/coffeecup.jpg", "assets/audio/coffee.mp3", "food", true, false, false, false);
    Subject subject14 = Subject("eat", "assets/images/food/eatingtimes.jpg", "assets/audio/test_audio.mp3", "food", false, true, false, false);
    Subject subject15 = Subject("egg", "assets/images/food/egg_broken.png", "assets/audio/egg.mp3", "food", true, false, false, false);
    Subject subject16 = Subject("fork", "assets/images/food/fork.jpg", "assets/audio/fork.mp3", "food", true, false, false, false);
    Subject subject17 = Subject("fruit", "assets/images/food/fruit.png", "assets/audio/fruit.mp3", "food", true, false, true, false);
    Subject subject18 = Subject("glass", "assets/images/food/glass.jpg", "assets/audio/glass.mp3", "food", true, false, false, false);
    Subject subject19 = Subject("kitchen utensils", "assets/images/food/kitchenutensils.jpg", "assets/audio/kitchenutensils.mp3", "food", true, false, false, false);
    Subject subject20 = Subject("knife", "assets/images/food/knife.jpg", "assets/audio/knife.mp3", "food", true, false, false, false);
    Subject subject21 = Subject("milk", "assets/images/food/milk-300x300.png", "assets/audio/milk.mp3", "food", true, false, false, false);
    Subject subject22 = Subject("mug", "assets/images/food/Mug-300x300.png", "assets/audio/mug.mp3", "food", true, false, false, false);
    Subject subject23 = Subject("plate", "assets/images/food/plate.jpg", "assets/audio/plate.mp3", "food", true, false, false, false);
    Subject subject24 = Subject("spoon", "assets/images/food/spoon.jpeg", "assets/audio/spoon.mp3", "food", true, false, false, false);
    Subject subject25 = Subject("rice", "assets/images/food/white_rice.jpg", "assets/audio/rice.mp3", "food", true, false, true, false);
    Subject subject26 = Subject("pineapple", "assets/images/food/.jpg", "assets/audio/pineapple.mp3", "food", true, false, false, false);
